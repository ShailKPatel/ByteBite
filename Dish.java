...
public class Dish {
    ...
    private void setDishCourse() {
        ...
        switch (choice) {
            case 1: this.dishCourse = "Appetizer"; break;
            case 2: this.dishCourse = "Soup"; break;
            case 3: this.dishCourse = "Salad"; break;
            case 4: this.dishCourse = "Entree"; break;
            case 5: this.dishCourse = "Main Course"; break;
            case 6: this.dishCourse = "Side Dish"; break;
            case 7: this.dishCourse = "Dessert"; break;
            case 8: this.dishCourse = "Beverage"; break;
            case 9: this.dishCourse = "Palate Cleanser"; break;
            case 10: this.dishCourse = "Other"; break;
            default:
    ...
    private void setDishCuisine() {
        ...
        do {
            ...
            switch (choice) {
                case 0: break;
                case 1: this.dishCuisineTags.add("Indian"); break;
                case 2: this.dishCuisineTags.add("South Indian"); break;
                case 3: this.dishCuisineTags.add("Gujarati"); break;
                case 4: this.dishCuisineTags.add("Punjabi"); break;
                case 5: this.dishCuisineTags.add("Chinese"); break;
                case 6: this.dishCuisineTags.add("Japanese"); break;
                case 7: this.dishCuisineTags.add("Italian"); break;
                case 8: this.dishCuisineTags.add("Mexican"); break;
                case 9: this.dishCuisineTags.add("Continental"); break;
                case 10:
    ...
    private void setDishDiet() {
        ...
        do {
            ...
            switch (choice) {
                case 0: break;
                case 1: this.dishDietTags.add("Vegetarian"); counter++; break;
                case 2: this.dishDietTags.add("Vegan"); counter++; break;
                case 3: this.dishDietTags.add("Keto"); counter++; break;
                case 4: this.dishDietTags.add("Gluten-Free"); counter++; break;
                case 5: this.dishDietTags.add("Low-Carb"); counter++; break;
                case 6: this.dishDietTags.add("Paleo"); counter++; break;
                case 7: this.dishDietTags.add("Dairy-Free"); counter++; break;
                case 8: this.dishDietTags.add("Nut-Free"); counter++; break;
                case 9: this.dishDietTags.add("Sugar-Free"); counter++; break;
                case 10:
